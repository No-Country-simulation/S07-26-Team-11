    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-1 border-t border-base-border/40 pt-4">
          <Link
            href="/admin/settings"
            className="flex items-center gap-2.5 rounded-md px-3.5 py-2 text-sm text-text-secondary hover:bg-black/5 hover:text-text-primary"
          >
          ...
          <button
            type="button"
            className="flex w-full items-center gap-2.5 rounded-md px-3.5 py-2 text-sm text-text-secondary hover:bg-black/5 hover:text-text-primary cursor-pointer"
          >
            <svg className="h-4 w-4 stroke-current" fill="none" viewBox="0 0 24 24" strokeWidth="2">
